...
using System;
using JuicyUO.Core.Audio.MP3Sharp.Decoding.Decoders.LayerIII;
using JuicyUO.Core.Audio.MP3Sharp.Support;

namespace JuicyUO.Core.Audio.MP3Sharp.Decoding.Decoders
{
    /// <summary>
