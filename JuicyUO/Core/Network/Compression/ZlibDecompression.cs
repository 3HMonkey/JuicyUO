...
namespace JuicyUO.Core.Network.Compression
{
    /// <summary>
    ...
    {
        private static int[] m_huffmanTable = {
        ...
        public static readonly IZLibCompressor Compressor;
    ...
    public sealed class Compressor32 : IZLibCompressor
    {
    ...
    public sealed class Compressor64 : IZLibCompressor
    {
        [DllImport("zlib64")]
        private static extern string zlibVersion();
    ...
    public sealed class CompressorUnix : IZLibCompressor
    {
        [DllImport("libz")]
        private static extern string zlibVersion();
