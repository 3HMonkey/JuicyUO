/***************************************************************************
*   IsometricWorld.fx
*   Copyright (c) 2009, 2015 JuicyUO Development Team
*
...
technique HueTechnique
{
	pass p0
	{
		...
		PixelShader = compile ps_4_0_level_9_1 PixelShader_Hue();
	}
}
...
technique MiniMapTechnique
{
	...
	{
		VertexShader = compile vs_4_0_level_9_1 VertexShaderFunction();
		PixelShader = compile ps_4_0_level_9_1 PixelShader_MiniMap();
	}
}
...
technique GrayscaleTechnique
{
	...
	{
		VertexShader = compile vs_4_0_level_9_1 VertexShaderFunction();
		PixelShader = compile ps_4_0_level_9_1 PixelShader_Grayscale();
	}
}
...
technique ShadowSetTechnique
{
	...
	{
		VertexShader = compile vs_4_0_level_9_1 VertexShaderFunction();
		PixelShader = compile ps_4_0_level_9_1 PixelShader_ShadowSet();
	}
}
